...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScheduleState<T>);
}
...
/// @nodoc
class $ScheduleStateCopyWith<T,$Res>  {
$ScheduleStateCopyWith(ScheduleState<T> _, $Res Function(ScheduleState<T>) __);
}


/// Adds pattern-matching-related methods to [ScheduleState].
extension ScheduleStatePatterns<T> on ScheduleState<T> {
...
class _Initial<T> implements ScheduleState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ScheduleState<$T>.initial()';
}
...
class Loading<T> implements ScheduleState<T> {
  const Loading();
...
@override
String toString() {
  return 'ScheduleState<$T>.loading()';
}
...
class Success<T> implements ScheduleState<T> {
...
@override
String toString() {
  return 'ScheduleState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ScheduleStateCopyWith<T, $Res> {
...
class Error<T> implements ScheduleState<T> {
...
@override
String toString() {
  return 'ScheduleState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ScheduleStateCopyWith<T, $Res> {
