...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AbsenceState<T>);
}
...
/// @nodoc
class $AbsenceStateCopyWith<T,$Res>  {
$AbsenceStateCopyWith(AbsenceState<T> _, $Res Function(AbsenceState<T>) __);
}


/// Adds pattern-matching-related methods to [AbsenceState].
extension AbsenceStatePatterns<T> on AbsenceState<T> {
...
class _Initial<T> implements AbsenceState<T> {
  const _Initial();
...
class Loading<T> implements AbsenceState<T> {
  const Loading();
...
class Success<T> implements AbsenceState<T> {
...
@override
String toString() {
  return 'AbsenceState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AbsenceStateCopyWith<T, $Res> {
...
class Error<T> implements AbsenceState<T> {
...
@override
String toString() {
  return 'AbsenceState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AbsenceStateCopyWith<T, $Res> {
