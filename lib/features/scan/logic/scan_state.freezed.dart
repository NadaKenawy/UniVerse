...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScanState<T>);
}
...
/// @nodoc
class $ScanStateCopyWith<T,$Res>  {
$ScanStateCopyWith(ScanState<T> _, $Res Function(ScanState<T>) __);
}


/// Adds pattern-matching-related methods to [ScanState].
extension ScanStatePatterns<T> on ScanState<T> {
...
class _Initial<T> implements ScanState<T> {
  const _Initial();
...
class Loading<T> implements ScanState<T> {
  const Loading();
...
class Success<T> implements ScanState<T> {
...
@override
String toString() {
  return 'ScanState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ScanStateCopyWith<T, $Res> {
...
class Error<T> implements ScanState<T> {
...
@override
String toString() {
  return 'ScanState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ScanStateCopyWith<T, $Res> {
