...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForgetPasswordState<T>);
}
...
/// @nodoc
class $ForgetPasswordStateCopyWith<T,$Res>  {
$ForgetPasswordStateCopyWith(ForgetPasswordState<T> _, $Res Function(ForgetPasswordState<T>) __);
}


/// Adds pattern-matching-related methods to [ForgetPasswordState].
extension ForgetPasswordStatePatterns<T> on ForgetPasswordState<T> {
...
class _Initial<T> implements ForgetPasswordState<T> {
  const _Initial();
...
class Loading<T> implements ForgetPasswordState<T> {
  const Loading();
...
class Success<T> implements ForgetPasswordState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ForgetPasswordStateCopyWith<T, $Res> {
...
class Error<T> implements ForgetPasswordState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ForgetPasswordStateCopyWith<T, $Res> {
