...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyPasswordState<T>);
}
...
/// @nodoc
class $VerifyPasswordStateCopyWith<T,$Res>  {
$VerifyPasswordStateCopyWith(VerifyPasswordState<T> _, $Res Function(VerifyPasswordState<T>) __);
}


/// Adds pattern-matching-related methods to [VerifyPasswordState].
extension VerifyPasswordStatePatterns<T> on VerifyPasswordState<T> {
...
class _Initial<T> implements VerifyPasswordState<T> {
  const _Initial();
...
@override
String toString() {
  return 'VerifyPasswordState<$T>.initial()';
}
...
class Loading<T> implements VerifyPasswordState<T> {
  const Loading();
...
@override
String toString() {
  return 'VerifyPasswordState<$T>.loading()';
}
...
class Success<T> implements VerifyPasswordState<T> {
...
@override
String toString() {
  return 'VerifyPasswordState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $VerifyPasswordStateCopyWith<T, $Res> {
...
class Error<T> implements VerifyPasswordState<T> {
...
@override
String toString() {
  return 'VerifyPasswordState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $VerifyPasswordStateCopyWith<T, $Res> {
