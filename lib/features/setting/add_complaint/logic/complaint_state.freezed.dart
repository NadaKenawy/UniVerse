...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ComplaintState<T>);
}
...
/// @nodoc
class $ComplaintStateCopyWith<T,$Res>  {
$ComplaintStateCopyWith(ComplaintState<T> _, $Res Function(ComplaintState<T>) __);
}


/// Adds pattern-matching-related methods to [ComplaintState].
extension ComplaintStatePatterns<T> on ComplaintState<T> {
...
class _Initial<T> implements ComplaintState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ComplaintState<$T>.initial()';
}
...
class Loading<T> implements ComplaintState<T> {
  const Loading();
...
@override
String toString() {
  return 'ComplaintState<$T>.loading()';
}
...
class Success<T> implements ComplaintState<T> {
...
@override
String toString() {
  return 'ComplaintState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ComplaintStateCopyWith<T, $Res> {
...
class Error<T> implements ComplaintState<T> {
...
@override
String toString() {
  return 'ComplaintState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ComplaintStateCopyWith<T, $Res> {
