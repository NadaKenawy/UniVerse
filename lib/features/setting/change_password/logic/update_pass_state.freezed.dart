...
part of 'update_pass_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdatePassState<T>);
}
...
/// @nodoc
class $UpdatePassStateCopyWith<T,$Res>  {
$UpdatePassStateCopyWith(UpdatePassState<T> _, $Res Function(UpdatePassState<T>) __);
}


/// Adds pattern-matching-related methods to [UpdatePassState].
extension UpdatePassStatePatterns<T> on UpdatePassState<T> {
...
class _Initial<T> implements UpdatePassState<T> {
  const _Initial();
...
@override
String toString() {
  return 'UpdatePassState<$T>.initial()';
}
...
class Loading<T> implements UpdatePassState<T> {
  const Loading();
...
@override
String toString() {
  return 'UpdatePassState<$T>.loading()';
}
...
class Success<T> implements UpdatePassState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of UpdatePassState
...
@override
String toString() {
  return 'UpdatePassState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $UpdatePassStateCopyWith<T, $Res> {
...
class Error<T> implements UpdatePassState<T> {
...
@override
String toString() {
  return 'UpdatePassState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $UpdatePassStateCopyWith<T, $Res> {
