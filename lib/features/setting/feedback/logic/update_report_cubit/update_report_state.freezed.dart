...
part of 'update_report_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateReportState<T>);
}
...
/// @nodoc
class $UpdateReportStateCopyWith<T,$Res>  {
$UpdateReportStateCopyWith(UpdateReportState<T> _, $Res Function(UpdateReportState<T>) __);
}


/// Adds pattern-matching-related methods to [UpdateReportState].
extension UpdateReportStatePatterns<T> on UpdateReportState<T> {
...
class _Initial<T> implements UpdateReportState<T> {
  const _Initial();
...
@override
String toString() {
  return 'UpdateReportState<$T>.initial()';
}
...
class Loading<T> implements UpdateReportState<T> {
  const Loading();
...
@override
String toString() {
  return 'UpdateReportState<$T>.loading()';
}
...
class Success<T> implements UpdateReportState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of UpdateReportState
...
@override
String toString() {
  return 'UpdateReportState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $UpdateReportStateCopyWith<T, $Res> {
...
class Error<T> implements UpdateReportState<T> {
...
@override
String toString() {
  return 'UpdateReportState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $UpdateReportStateCopyWith<T, $Res> {
