...
part of 'available_subjects_state.dart';
...
/// @nodoc
mixin _$AvailableSubjectsState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AvailableSubjectsState<T>);
}
...
@override
String toString() {
  return 'AvailableSubjectsState<$T>()';
}
...
/// @nodoc
class $AvailableSubjectsStateCopyWith<T,$Res>  {
$AvailableSubjectsStateCopyWith(AvailableSubjectsState<T> _, $Res Function(AvailableSubjectsState<T>) __);
}


/// Adds pattern-matching-related methods to [AvailableSubjectsState].
extension AvailableSubjectsStatePatterns<T> on AvailableSubjectsState<T> {
...
class _Initial<T> implements AvailableSubjectsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'AvailableSubjectsState<$T>.initial()';
}
...
class Loading<T> implements AvailableSubjectsState<T> {
  const Loading();
...
@override
String toString() {
  return 'AvailableSubjectsState<$T>.loading()';
}
...
class Success<T> implements AvailableSubjectsState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of AvailableSubjectsState
...
@override
String toString() {
  return 'AvailableSubjectsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AvailableSubjectsStateCopyWith<T, $Res> {
...
class Error<T> implements AvailableSubjectsState<T> {
...
@override
String toString() {
  return 'AvailableSubjectsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AvailableSubjectsStateCopyWith<T, $Res> {
