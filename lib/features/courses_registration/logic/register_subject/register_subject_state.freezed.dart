...
part of 'register_subject_state.dart';
...
/// @nodoc
mixin _$RegisterSubjectState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterSubjectState<T>);
}
...
/// @nodoc
class $RegisterSubjectStateCopyWith<T,$Res>  {
$RegisterSubjectStateCopyWith(RegisterSubjectState<T> _, $Res Function(RegisterSubjectState<T>) __);
}


/// Adds pattern-matching-related methods to [RegisterSubjectState].
extension RegisterSubjectStatePatterns<T> on RegisterSubjectState<T> {
...
class _Initial<T> implements RegisterSubjectState<T> {
  const _Initial();
...
@override
String toString() {
  return 'RegisterSubjectState<$T>.initial()';
}
...
class Loading<T> implements RegisterSubjectState<T> {
  const Loading();
...
@override
String toString() {
  return 'RegisterSubjectState<$T>.loading()';
}
...
class Success<T> implements RegisterSubjectState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of RegisterSubjectState
...
@override
String toString() {
  return 'RegisterSubjectState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $RegisterSubjectStateCopyWith<T, $Res> {
...
class Error<T> implements RegisterSubjectState<T> {
...
@override
String toString() {
  return 'RegisterSubjectState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $RegisterSubjectStateCopyWith<T, $Res> {
